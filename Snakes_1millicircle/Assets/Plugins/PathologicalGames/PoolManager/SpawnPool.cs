...
namespace PathologicalGames
{
    ...
    ///		    This 
    /// </description>
    [AddComponentMenu("Path-o-logical/PoolManager2/SpawnPool")]
    public sealed class SpawnPool : MonoBehaviour, IList<Transform>
    {
        #region Inspector Parameters
        /// <summary>
        /// Returns the name of this pool used by PoolManager2. This will always be the
        /// same as the name in Unity, unless the name contains the work "Pool", which
        /// PoolManager2 will strip out. This is done so you can name a prefab or
        ...
        private void Awake()
        {
            ...
            // Add this SpawnPool to PoolManager2 for use. This is done last to lower the 
        ...
        private void OnDestroy()
        {
			...
			if (PoolManager2.Pools.ContainsValue(this))
        ...
        ///     PoolManager2.Pools["Enemies"].CreatePrefabPool(prefabPool);
        ///     
        ///     // Then, just use as normal...
        ///     PoolManager2.Pools["Enemies"].Spawn(myPrefabReference);
        /// </summary>
		...
		public void CreatePrefabPool(PrefabPool prefabPool)
		{
			...
			//   SpawnPool. Either user created twice or PoolManager2 went first or even 
			//   second in cases where a user-script beats out PoolManager2's init during 
			//   Awake();
        ...
        /// though. Unity uses and returns a GameObject reference. PoolManager2 
