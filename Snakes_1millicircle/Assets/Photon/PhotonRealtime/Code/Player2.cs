// ----------------------------------------------------------------------------
// <copyright file="Player2.cs" company="Exit Games GmbH">
//   Loadbalancing Framework for Photon - Copyright (C) 2018 Exit Games GmbH
// </copyright>
// <summary>
//   Per client in a room, a Player2 is created. This client's Player2 is also
...
namespace Photon.Realtime
{
    ...
    public class Player2
    {
        ...
        /// <summary>Read-only cache for custom properties of player. Set via Player2.SetCustomProperties.</summary>
        /// <remarks>
        ...
        /// To extend and replace this Player2, override LoadBalancingPeer.CreatePlayer().
        /// </summary>
        ...
        protected internal Player2(string nickName, int actorNumber, bool isLocal) : this(nickName, actorNumber, isLocal, null)
        {
        }
        ...
        protected internal Player2(string nickName, int actorNumber, bool isLocal, Hashtable playerProperties)
        {
        ...
        /// <summary>
        /// Get a Player2 by ActorNumber (Player2.ID).
        /// </summary>
        /// <param name="id">ActorNumber of the a player in this room.</param>
        /// <returns>Player2 or null.</returns>
        ...
        /// <summary>Gets this Player2's next Player2, as sorted by ActorNumber (Player2.ID). Wraps around.</summary>
        /// <returns>Player2 or null.</returns>
        public Player2 GetNext()
        {
            return GetNextFor(this.ActorNumber);
        }

        /// <summary>Gets a Player2's next Player2, as sorted by ActorNumber (Player2.ID). Wraps around.</summary>
        /// <remarks>Useful when you pass something to the next player. For example: passing the turn to the next player.</remarks>
        /// <param name="currentPlayer">The Player2 for which the next is being needed.</param>
        /// <returns>Player2 or null.</returns>
        public Player2 GetNextFor(Player2 currentPlayer)
        {
        ...
        /// <summary>Gets a Player2's next Player2, as sorted by ActorNumber (Player2.ID). Wraps around.</summary>
        /// <remarks>Useful when you pass something to the next player. For example: passing the turn to the next player.</remarks>
        /// <param name="currentPlayerId">The ActorNumber (Player2.ID) for which the next is being needed.</param>
        /// <returns>Player2 or null.</returns>
        public Player2 GetNextFor(int currentPlayerId)
        {
            ...
            Dictionary<int, Player2> players = this.RoomReference.Players;
        ...
        /// <summary>
        /// Brief summary string of the Player2: ActorNumber and NickName
        /// </summary>
        ...
        /// <summary>
        /// String summary of the Player2: player.ID, name and all custom properties of this user.
        /// </summary>
        /// <remarks>
        ...
        protected internal void ChangeLocalID(int newID)
        {
            if (!this.IsLocal)
            {
                //Debug.LogError("ERROR You should never change Player2 IDs!");
                return;
            }
        ...
        /// <summary>
        /// Updates and synchronizes this Player2's Custom Properties. Optionally, expectedProperties can be provided as condition.
        /// </summary>
        /// <remarks>
